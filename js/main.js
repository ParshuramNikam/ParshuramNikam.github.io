...
/* EXPERIENCE SECTION */
// sr.reveal('.experience_container', { delay: 20 })
sr.reveal('.experience_container', { delay: 300 })

/*SCROLL WORKS*/
sr.reveal('.works_img', { interval: 200 })

sr.reveal('.project1', { interval: 300 })
sr.reveal('.project2', { interval: 400 })
sr.reveal('.project3', { interval: 600 })

// /*SCROLL CONTACT*/
sr.reveal('#contact', { interval: 300, delay: 300 })
